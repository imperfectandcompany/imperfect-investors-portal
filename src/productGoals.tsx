...
const ProductGoals: FunctionalComponent = () => {

  return (
    <div class="max-w-6xl mx-auto px-4 py-8">
        <h1 class="text-4xl font-bold mb-6">Product Goals</h1>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="border-2 border-orange-500 p-6">
                <h2 class="text-2xl font-semibold mb-4">Safe Space for Genuine Posting</h2>
            ...
            <div class="border-2 border-orange-500 p-6">
                <h2 class="text-2xl font-semibold mb-4">Restore Authentic Social Interaction</h2>
            ...
            <div class="border-2 border-orange-500 p-6">
                <h2 class="text-2xl font-semibold mb-4">Transparent Data Practices</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
            <div class="border-2 border-orange-500 p-6">
                <h2 class="text-2xl font-semibold mb-4">Thoughtful Posting Process</h2>
            ...
            <div class="border-2 border-orange-500 p-6">
                <h2 class="text-2xl font-semibold mb-4">User-Centric Control</h2>
