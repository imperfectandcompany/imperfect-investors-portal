import "./chunk-6XB3SNET.js";
import {
  b,
  k,
  l
} from "./chunk-7CXLY5DB.js";
  ...
  l.vnode = function(n2) {
    ...
    if (e.__k && e.__k.forEach(function(n2) {
      ...
      if ("" !== s2)
        ...
        "a" !== o2 && "button" !== o2 || -1 !== d(e).indexOf(o2) && console.error("Improper nesting of interactive content. Your <" + o2 + "> should not have other " + ("a" === o2 ? "anchor" : "button") + " tags as child-elements." + w(e) + "\n\n" + f(e));
    }
    if (n = false, r2 && r2(e), null != e.__k)
    ...
    if (null != e.__c && null != e.__c.__H) {
      var b4 = e.__c.__H.__;
      if (b4)
        for (var g2 = 0; g2 < b4.length; g2 += 1) {
          var E2 = b4[g2];
          if (E2.__H) {
